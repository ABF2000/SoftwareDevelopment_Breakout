...
namespace Breakout.BreakoutStates{
    /// <summary>
    /// Class to handle the game if the game is won. Will display the final score and a 
    /// menu the user can navigate.
    /// </summary>
    public class GameWon : Menu, IGameState {
        ...
        private void InitializeGameState() {
            ...
            headLine = new Text("YOU WIN!", new Vec2F(0.35f, 0.3f), new Vec2F(0.4f, 0.5f));
            headLine.SetColor(standardColor);    
        }   

        public void RenderState() {
            RenderMenu();
            Score.GameOverScore(true); // Moves the score and changes the color
        }
